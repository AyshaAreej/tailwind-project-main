...
const StillHaveQuestions: React.FC = () => {
  return (
    <div className="bg-questions py-4 px-6 shadow rounded-lg max-w-6xl mx-auto mb-20 mt-8 flex flex-col md:flex-row justify-between items-center">
      ...
      <Link to="/contact">
        <button className="bg-orange-400 hover:bg-orange-500 text-white text-sm font-medium py-2 px-4 rounded cursor-pointer">
          CONTACT US
        </button>
      </Link>
    </div>
