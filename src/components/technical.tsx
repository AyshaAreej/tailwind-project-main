...
const TechnicalCapabilities: React.FC = () => {
  return (
    <section className="py-12 px-4 max-w-6xl mx-auto space-y-16">
      ...
      <h2 className="text-4xl leading-tight tracking-[-0.8px] font-bold text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div style={{ marginLeft: "40px" }}>
          <h4 className="text-5xl leading-tight tracking-[-0.8px] font-bold mb-8">
            Equipment & Tools
          </h4>
          <ul className="space-y-2">
            {[
              ...
              <li key={i} className="flex items-center gap-2">
                ...
                <span className="text-[16px] leading-[130%] font-normal text-gray-700">
                  {point}
                </span>
              </li>
            ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center md:flex-row-reverse">
        <div>
          <h4 className="text-5xl leading-tight font-bold mb-8">
            Quality Assurance & Testing
          </h4>
          <ul className="space-y-2">
            {[
      ...
      <h3 className="text-4xl leading-tight tracking-[-0.8px] font-bold text-center">
        Safety & Compliance
      </h3>
